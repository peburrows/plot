-file("/opt/boxen/homebrew/Cellar/erlang/17.5/lib/erlang/lib/parsetools-2.0.12/include/leexinc.hrl", 0).
...
-file("src/graphql_lexer.xrl", 19).

-file("/opt/boxen/homebrew/Cellar/erlang/17.5/lib/erlang/lib/parsetools-2.0.12/include/leexinc.hrl", 14).
...
yystate(8, [10|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line+1, Tlen+1, 8, Tlen);
...
-file("src/graphql_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { string, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/graphql_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_2/1}).
-file("src/graphql_lexer.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { ':', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/graphql_lexer.xrl", 10).
yyaction_3(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/graphql_lexer.xrl", 11).
yyaction_4(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/graphql_lexer.xrl", 12).
yyaction_5(TokenLine) ->
     { token, { '{', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/graphql_lexer.xrl", 13).
yyaction_6(TokenLine) ->
     { token, { '}', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/graphql_lexer.xrl", 14).
yyaction_7(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_8/0}).
-file("src/graphql_lexer.xrl", 15).
yyaction_8() ->
     skip_token .

-file("/opt/boxen/homebrew/Cellar/erlang/17.5/lib/erlang/lib/parsetools-2.0.12/include/leexinc.hrl", 282).
